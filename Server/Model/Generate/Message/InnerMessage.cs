...
//--------------------Player cache related protobuf--------------------
//four types cache protobuf: add | update | delete | get
// "O" is Other SceneType, "U" is UnitCache
	[ResponseType(nameof(U2O_AddOrUpdateUnit))]
	[Message(InnerOpcode.O2U_AddOrUpdateUnit)]
	[ProtoContract]
	public partial class O2U_AddOrUpdateUnit: Object, IActorRequest
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[Message(InnerOpcode.U2O_AddOrUpdateUnit)]
	[ProtoContract]
	public partial class U2O_AddOrUpdateUnit: Object, IActorResponse
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
...
//Get UnitCache
//Because GetUnitCache will return a lot Entity, so U2O_GetUnit response protobuf in MongoMessage.proto
	[ResponseType(nameof(U2O_GetUnit))]
	[Message(InnerOpcode.O2U_GetUnit)]
	[ProtoContract]
	public partial class O2U_GetUnit: Object, IActorRequest
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
...
//Delete UnitCache
	[ResponseType(nameof(U2O_DeleteUnit))]
	[Message(InnerOpcode.O2U_DeleteUnit)]
	[ProtoContract]
	public partial class O2U_DeleteUnit: Object, IActorRequest
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[Message(InnerOpcode.U2O_DeleteUnit)]
	[ProtoContract]
	public partial class U2O_DeleteUnit: Object, IActorResponse
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
